...
const TeamCard = ({ member, index }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="team-card bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden group border border-gray-200 dark:border-gray-700"
    >
      ...
      <div className="p-6">
        ...
        <p className="text-primary-600 dark:text-primary-400 font-medium mb-3">{member.position}</p>
